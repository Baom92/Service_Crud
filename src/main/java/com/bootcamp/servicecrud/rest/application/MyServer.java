 ...
 * permet de definir le web.xml par un code
 *
 */
...
public class MyServer {
    ...
    public static void main(String[] args) throws Exception
  {
      ...
      apiServlet.setInitParameter("com.sun.jersey.config.property.packages", "com.bootcamp.servicecrud.rest.controllers;io.swagger.jaxrs.json;io.swagger.jaxrs.listing");
